...
--- 
## My Own Todo's
- [ ] Add unit tests from mock xmls
- [ ] Test further special chars, specially for json output
- [ ] Test combinations of empty titles and descriptions
- [ ] Use Gen AI for docstrings :)
- [ ] Decouple presentation (field labels) consitently. Currently in two different places for json / text
- [ ] Print functions receive feed and the other a dict. Looks weird
